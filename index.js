...
const api = botBuilder(
	function (message, originalRequest) {
		...
		if (getIntentName(originalRequest.body) === 'ExitApp'){
            ...
            let text = "Here's your sentence to fill in the blank! " +
            ...
            // NO
                ...
                return new AlexaMessageBuilder()
                    ...
                    .get();
            // ACTUAL ANSWER
            } else if (question.answer == guess) {
                return new AlexaMessageBuilder()
                    .addText("You did it! Want to do another one?")
                    .addStandardCard("You did it!", "Want to do another one?", {
                        smallImageUrl: 'https://www.ookbeecomics.com/images/meme-18.png',
                        largeImageUrl: 'https://www.ookbeecomics.com/images/meme-18.png'})
                    .addSessionAttribute('questionData', question)
                    .keepSession()
                    .get()
            } else {
