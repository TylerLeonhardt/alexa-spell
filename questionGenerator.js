...
var randIndex = getRandomInt(sentences.length - 1);

var randSentence = sentences[randIndex];
console.log();

questionGenerator(sentences).then(function(response){
    console.log(response);
});

function questionGenerator(sentenceList) {
    var randSentence = sentences[getRandomInt(sentenceList.length - 1)];
